...
class CartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.length = 1  # "actually half the pole's length", real length is double this
        ...
        self.x_threshold = 20 #np.Inf  # remove?
    ...
    def limit_check(self, theta, x):
        ...
        if 0 <= x < self.x_threshold or - self.x_threshold < x <= 0:
            ...
            if self.above is True:
                if ((2 * math.pi + self.theta_threshold_radians) < theta) or (3/2*math.pi < theta < 2 * math.pi - self.theta_threshold_radians) \
                    or (self.theta_threshold_radians < theta < math.pi/2) or (theta < - self.theta_threshold_radians):
    ...
    def render(self, mode='human'):
        ...
        polewidth = 10.0
        polelen = scale * (4 * self.L)  # self.length)
        cartwidth = 50.0
        cartheight = 30.0
