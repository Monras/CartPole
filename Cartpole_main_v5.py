...
keep_prob = 0.8
epoch = 1
step = 60  # tweak variable to find the right range of the force
lower = step
upper = step*3 + 1
...
if __name__ == "__main__":
    ...
    # model_3 = load_model('cartpole_model_v3_1_2.tflearn', input_size, output_size)


    """Create new training_data (randomly!)"""

    # training_data_1 = create_training_data(env, theta_limit_1, score_limit=score_limit_1, save=True, file_name='training_data_v5_1_1.hdf5',
    ...
    """Creates or trains new models based on the training data"""
    # model_1 = train_model(training_data_1, model=False, new_model=True, save=True, file_name='cartpole_model_v5_1_1.tflearn')
    ...
    training_data_1_trained = NN_simulation(env, model_1, theta_limit_sim, score_limit_sim, N_runs_sim, N_steps_per_run_sim,
                                            save_data=False, save_hist=False, animation=True, file_name='training_data_v3_2_1_trained.hdf5')