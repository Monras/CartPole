...
class CartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.theta_threshold_radians = math.pi/2  # sets the limit for how far the pendelum can travel
    ...
    def reset(self):
        # self.theta_threshold_radians = theta_lim*math.pi/180 if you want to change theta lim every reset, se version 10 and older
